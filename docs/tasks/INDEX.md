...
| WP-01 | iOS project hardening | M | WP-00 | todo | – |
| WP-02 | CI and check script | S | WP-00 | todo | – |
| WP-03 | App shell | M | WP-00 | todo | – |
| WP-04 | chessground (vendored trimmed copy), asset allow-list, `BoardView` | M | WP-00, H1 | review | [WP-04](WP-04-chessground-and-boardview.md) |
